...
// YENİ: Türkçe dil desteği paketini import ediyoruz
// Not: Bu paketin 'yarn add @nlpjs/lang-tr' ile kurulu olması GEREKİR.
import { LangTr } from "@nlpjs/lang-tr";

/**
 * Müşteriye özel NLU motorunu eğitir ve bir mesajı işler.
 * @param {string} message - Kullanıcının gönderdiği mesaj (POST'ta küçük harfe çevrildi)
...
export async function processMessageWithNlp(message, intents) {
  ...
  try {
    ...
    // Eşik değeri 0.5 (düşürülmüş eşik)
    ...
    // Hata durumunda da varsayılan cevaba düşmesi için 'None' döndür
    return { intent: "None", score: 0 };
  }
}
